...
template<>
struct ggml_cuda_type_traits<GGML_TYPE_TQ_KV_4B_UNIFORM> {
    static constexpr int qk = QK_TQ_KV_4B_UNIFORM;
    static constexpr int qr = QR_TQ_KV_4B_UNIFORM;
    static constexpr int qi = QI_TQ_KV_4B_UNIFORM;
};
