...
static void ggml_cuda_get_rows_switch_src0_type(
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_Q1_0_g128:
            get_rows_cuda_q<QK1_0_g128, QR1_0_g128, dequantize_q1_0_g128>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_Q4_0:
        ...
        case GGML_TYPE_TQ_KV_4B_UNIFORM:
            get_rows_cuda_q<QK_TQ_KV_4B_UNIFORM, QR_TQ_KV_4B_UNIFORM, dequantize_tq_kv_4b_uniform>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        default:
            // TODO: k-quants
