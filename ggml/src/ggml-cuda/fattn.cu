...
static void ggml_cuda_flash_attn_ext_vec(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0,             GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_1,             GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q5_0,             GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q5_1,             GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q8_0,             GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_BF16,             GGML_TYPE_TQ_KV_4B_UNIFORM)

    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_F16)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_Q4_0)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_Q4_1)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_Q5_0)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_Q5_1)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_Q8_0)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_BF16)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q8_0, GGML_TYPE_Q8_0)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_BF16, GGML_TYPE_BF16)
    // TQ_KV_4B_UNIFORM 支持: 同类型 + 常见混合组合
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_F16,  GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_F16)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_TQ_KV_4B_UNIFORM, GGML_TYPE_TQ_KV_4B_UNIFORM)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0, GGML_TYPE_TQ_KV_4B_UNIFORM)
